$axure.internal(function($ax) {
    ...
    var _getFourCorners = $ax.public.fn.getFourCorners = function (query, delta) {
        ...
        var widgetBottomRightRotated = { x: Number(thisElt[0].getAttribute('widgetbottomrightx')) + delta.x, y: Number(thisElt[0].getAttribute('widgetbottomrighty')) + delta.y };
        var widgetTopRightRotated = { x: Number(thisElt[0].getAttribute('widgettoprightx')) + delta.x, y: Number(thisElt[0].getAttribute('widgettoprighty')) + delta.y };
        var widgetBottomLeftRotated = { x: Number(thisElt[0].getAttribute('widgetbottomleftx')) + delta.x, y: Number(thisElt[0].getAttribute('widgetbottomlefty')) + delta.y };
        var widgetTopLeftRotated = { x: Number(thisElt[0].getAttribute('widgettopleftx')) + delta.x, y: Number(thisElt[0].getAttribute('widgettoplefty')) + delta.y };
